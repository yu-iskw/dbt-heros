#!/bin/bash
# safety.sh
# Deterministic safety check for Lightdash AgentOps destructive tools.
...
# Define destructive tools for AgentOps
DESTRUCTIVE_TOOLS=("ldt__delete_project_agent" "ldt__delete_agent_evaluation")
